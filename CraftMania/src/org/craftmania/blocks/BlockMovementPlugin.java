...
public class BlockMovementPlugin
{
	...
	public void solveMotion()
	{
		...
		{
			Game.getInstance().getWorld().getChunkManager().rememberBlockMovement(_block, _block.getX(), _block.getY(), _block.getZ(), _block.getX() + moveX, _block.getY() + moveY, _block.getZ() + moveZ);
		}
